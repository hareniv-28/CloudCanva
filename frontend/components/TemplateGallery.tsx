...
const templates: Template[] = [
  {
    ...
    nodes: [
      ...
      { id: "tpl-alb", type: "service", position: { x: 150, y: 350 }, data: { label: "LoadBalancer", type: "LoadBalancer", provider: "aws", rawLabel: "load_balancer", serviceName: "App ALB", properties: { name: "app-alb", load_balancer_type: "application", internal: false, tags: {} } } },
      { id: "tpl-ec2", type: "service", position: { x: 300, y: 500 }, data: { label: "EC2", type: "compute", provider: "aws", rawLabel: "aws_instance", serviceName: "Web Server", properties: { name: "web-server", ami: "ami-0c55b159cbfafe1f0", instance_type: "t3.medium", tags: {}, refs: {} } } },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "tpl-s3", type: "service", position: { x: 250, y: 250 }, data: { label: "S3", type: "storage", provider: "aws", rawLabel: "s3_bucket", serviceName: "Website Bucket", properties: { bucket: "my-static-website", region: "us-east-1", acl: "public-read", versioning: { enabled: true }, tags: {} } } },
      { id: "tpl-ec2", type: "service", position: { x: 450, y: 250 }, data: { label: "EC2", type: "compute", provider: "aws", rawLabel: "aws_instance", serviceName: "Build Server", properties: { name: "build-server", ami: "ami-0c55b159cbfafe1f0", instance_type: "t3.micro", tags: {}, refs: {} } } },
    ],
    edges: [
